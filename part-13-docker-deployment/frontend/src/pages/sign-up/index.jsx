  ...
  return (
      ...
      <section className="bg-black ">
        ...
        <div className="flex items-center justify-center min-h-screen bg-gray-100 text-left ">
            <div class="w-full max-w-xs m-auto bg-indigo-100 rounded p-5 shadow-lg">  
              <header>
              ...
              <footer>
                <Link class="text-teal-700 hover:text-blue-900 text-sm float-right" to="/login">Already Have an account ?</Link>
              </footer> 
            </div>
          </div>
      </section>
